...
let backToPagePaciente = document.querySelector("input[backToPaciente]");
if(backToPagePaciente) {
    backToPagePaciente.addEventListener("click", () => {
        let url = backToPagePaciente.getAttribute("backToPaciente");
        window.location.href = url;
    })
}
